...
public class HRestClient {
    ...
    public static int code = 495;

    public static int CONNECT_TIMEOUT = 600000;
    ...
    private String user_agent = "Android" + Build.MODEL;
    ...
    public String _POST(String dataJSON) {
        ...
        Logger.i("API REQUEST : (0:00) "+ dataJSON);
        ...
        try {
            ...
            if("http".equals(url.getProtocol())){
                ...
                urlConnection_http.setRequestProperty("User-Agent", user_agent);
    ...
    private HostnameVerifier hostnameVerifier (){
        ...
        return new HostnameVerifier() {
            ...
            public boolean verify(String hostname, SSLSession session) {
                ...
                return HConstant.DEBUG ? true :  host.verify(HOST, session);
            }
        };
    }
