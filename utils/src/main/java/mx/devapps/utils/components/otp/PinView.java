...
package mx.devapps.utils.components.otp;
...
public class PinView extends AppCompatEditText {
    ...
    ITextChanged changed = new ITextChanged() {
        @Override
    ...
    protected void onTextChanged(CharSequence text, int start, int lengthBefore, int lengthAfter) {
        ...
        if(changed != null) {
            changed.onChange(getText().length());
    ...
    public Boolean isValid() {
        return getText().length() == mPinItemCount;
    }
    ...
    public void setChanged(ITextChanged changed) {
