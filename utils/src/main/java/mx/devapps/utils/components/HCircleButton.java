...
public class HCircleButton extends ImageView {
    ...
    public HCircleButton(Context context) {
        super(context);
        init(context, null);
    }

    public HCircleButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public HCircleButton(Context context, AttributeSet attrs, int defStyle) {
