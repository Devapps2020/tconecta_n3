package mx.devapps.utils.exceptions;
...
import mx.devapps.utils.components.HThrowException;

public final class HExceptionHandler {
    ...
    private final static String TAG = "HExceptionHandler";
    private static final String UCE_HANDLER_PACKAGE_NAME = "mx.devapps.utils";
    ...
    HExceptionHandler(Builder builder) {
        ...
        setHExceptionHandler(builder.context);
    }

    private static void setHExceptionHandler(final Context context) {
        try {
            if (context != null) {
                ...
                if (oldHandler != null && oldHandler.getClass().getName().startsWith(UCE_HANDLER_PACKAGE_NAME)) {
                            ...
                            if (isUCEHEnabled) {
                                ...
                                if (hasCrashedInTheLastSeconds(application)) {
                                    ...
                                    if (!isInBackground || isBackgroundMode) {
                                        final Intent intent = new Intent(application, HThrowException.class);
                    ...
                    application.registerActivityLifecycleCallbacks(new Application.ActivityLifecycleCallbacks() {
                        ...
                        public void onActivityCreated(Activity activity, Bundle savedInstanceState) {
                            if (activity.getClass() != HThrowException.class) {
    ...
    public static class Builder {
        ...
        public Builder addLauncher(Class launch) {
            this.launch = launch;
            return this;
        }

        public HExceptionHandler build() {
            return new HExceptionHandler(this);
        }
