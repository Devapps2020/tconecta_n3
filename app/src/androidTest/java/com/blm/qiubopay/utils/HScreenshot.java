...
public final class HScreenshot {
     ...
     * @param image    a screenshot identifier
     * @return path to the screenshot file
     */
    public static String capture(String folder, String name, String image) {
    ...
    private static class EspressoScreenCaptureProcessor extends BasicScreenCaptureProcessor {
        ...
        EspressoScreenCaptureProcessor() {
            ...
            File classDir = new File(screenshotDir, folderName);
            mDefaultScreenshotPath = new File(classDir, className);
        }
