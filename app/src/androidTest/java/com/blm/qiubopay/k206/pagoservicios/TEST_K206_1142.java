...
public class TEST_K206_1142 extends HBase {

    

    @Test
    public void TEST_K206_1142() {
        ...
        HTest.scrollRecycler(new HItem(18));
        ...
        HTest.setValueInput(new HItem("Monto",DATA.SERVICIOS.MONTO_PLAN_MOVISTAR,0));
