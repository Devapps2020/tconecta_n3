...
public class TEST_K206_1027 extends HBase {

    @Test
    public void TEST_K206_1027() {
        ...
        HTest.setValueInput(new HItem("Número de referencia",DATA.SERVICIOS.NUMERO_REFERENCIA_SKY));

        HTest.clickButton(new HItem("CONTINUAR",1));

        HTest.setValueInput(new HItem("Monto",DATA.SERVICIOS.MONTO_SKY,0));
