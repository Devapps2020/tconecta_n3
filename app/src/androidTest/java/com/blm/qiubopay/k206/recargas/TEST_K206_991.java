...
public class TEST_K206_991 extends HBase {
    
    @Test
    public void TEST_K206_991() {
        ...
        HTest.setValueInput(new HItem("Confirma número de teléfono",DATA.RECARGAS.NUMERO_VIRGINMOBILE,1));
