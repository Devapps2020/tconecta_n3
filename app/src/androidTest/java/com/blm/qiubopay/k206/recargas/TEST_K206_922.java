...
public class TEST_K206_922 extends HBase {

    @Test
    public void TEST_K206_922() {
        ...
        HTest.setValueInput(new HItem("Confirma número de teléfono",DATA.RECARGAS.NUMERO_TELCEL,1));
