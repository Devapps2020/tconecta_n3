...
public class TEST_K206_1677 extends HBase {

    @Test
    public void TEST_K206_1677() {
        ...
        HTest.setValueInputDate(new HItem("Fecha transacción", DATA.DEPOSITO.SANTANDER.FECHA_TRANSACCION, 2));
