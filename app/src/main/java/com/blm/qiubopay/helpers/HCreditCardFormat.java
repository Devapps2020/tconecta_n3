 ...
 */
public class HCreditCardFormat implements TextWatcher {
     ...
     */
    public HCreditCardFormat(int paddingPx) {
     ...
     */
    public HCreditCardFormat(@NonNull TextView textView) {
     ...
     */
    public HCreditCardFormat(@NonNull TextView textView, float paddingEm) {
     ...
     */
    public HCreditCardFormat(@NonNull Context context, float paddingSp) {
