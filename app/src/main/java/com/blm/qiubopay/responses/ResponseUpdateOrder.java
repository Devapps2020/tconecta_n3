...
import com.blm.qiubopay.responses.dynamicdata.DynamicDataUpdateOrder;
...
public class ResponseUpdateOrder {
    ...
    private List<DynamicDataUpdateOrder> qpay_object;
    ...
    public List<DynamicDataUpdateOrder> getQpay_object() {
        return qpay_object;
    }

    public void setQpay_object(List<DynamicDataUpdateOrder> qpay_object) {
        this.qpay_object = qpay_object;
    }

    /*private String responseCode, responseDescription;
    private DynamicDataUpdateOrder dynamicData;
    ...
    public DynamicDataUpdateOrder getDynamicData() {
        return dynamicData;
    }

    public void setDynamicData(DynamicDataUpdateOrder dynamicData) {
