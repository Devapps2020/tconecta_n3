...
public class QPAY_FinancialVasResponse extends QPAY_BaseResponse implements Serializable {
    ...
    public static class QPAY_FinancialVasResponseExcluder implements ExclusionStrategy {
        ...
        public boolean shouldSkipField(FieldAttributes f) {
            return f.getDeclaredType().equals(QPAY_FinancialVasResponse.class);
        }
