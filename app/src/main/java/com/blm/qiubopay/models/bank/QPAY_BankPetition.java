...
public class QPAY_BankPetition implements Serializable {
    private String qpay_clabe;
    private String qpay_seed;
    private QPAY_DeviceInfo[] qpay_device_info;

    //Constructor
    public QPAY_BankPetition() {
        qpay_device_info = new QPAY_DeviceInfo[1];
        QPAY_DeviceInfo deviceInfo = new QPAY_DeviceInfo();
        this.qpay_device_info[0] = deviceInfo;
    }

    public String getQpay_clabe() {
        return qpay_clabe;
    }

    public void setQpay_clabe(String qpay_clabe) {
        this.qpay_clabe = qpay_clabe;
    }
